...
import appsuite.data.repository.AccountRepository;
...
public class SecurityConfiguration {
	 ...
	 * 
	 * @Override public void run(String... arg0) throws Exception { Account
	 * account = new Account("rbaxter", "password"); account.setId("1");
