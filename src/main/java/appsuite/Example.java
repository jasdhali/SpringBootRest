...
public class Example {
	 ...
	 * SpringApplication app = new SpringApplication( ); return app; }
	 */
	...
	/*
	 * @RequestMapping(value="/items", method=RequestMethod.POST) public
	 * ResponseEntity<Item> createAsset(@RequestBody Item item) { Item newItem =
	 * itemService.createAsset(asset); return new
	 * ResponseEntity<Asset>(newAsset, HttpStatus.OK); }
	 */
}